...
import com.rojunaid.roacademy.security.oauth2.user.OAuth2UserInfo;
import com.rojunaid.roacademy.security.oauth2.user.OAuth2UserInfoFactory;
    ...
    if (userOptional.isPresent()) {
      ...
      if (!user.getProvider()
        ...
        throw new OAuth2AuthenticationProcessingException(
            "Look like your're signed up with"
                + user.getProvider()
